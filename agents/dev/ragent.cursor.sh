...
#
# Entry: agents/dev/ragent.cursor.sh — delegates to ../../scripts/ragent.cursor.agent-dir.sh.
#   **--workspace** = git repo root; **cwd** = agents/dev (matches “start in this agent dir” pattern).
#   Shell alias when installed: sma.dev.cursor
#
