...
function resolveProjectRoot(): string {
  // Script lives at: <root>/agents/agent.manager/scripts.manager/task-management.script.ts
...
Usage:
  ...
  npx tsx ./agents/agent.manager/scripts.manager/task-management.script.ts <command> [args]
