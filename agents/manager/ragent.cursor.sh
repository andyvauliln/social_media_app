...
#
# Entry: agents/manager/ragent.cursor.sh — delegates to ../../scripts/ragent.cursor.agent-dir.sh.
#   **--workspace** = git repo root; **cwd** = agents/manager (matches “start in this agent dir” pattern).
