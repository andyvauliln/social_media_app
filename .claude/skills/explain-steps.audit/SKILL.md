...
description: Reformat raw Claude turn audit steps into a structured numbered narrative. Each step gets a title, goal, tool used, and result/action. Uses claude-haiku-4-5-20251001.
